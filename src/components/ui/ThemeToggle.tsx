    ...
    return (
      ...
      >
        <AnimatePresence mode="wait" initial={false}>
          ...
          >
            {isDark ? <Moon className="h-5 w-5 text-ai-blue" /> : <Sun className="h-5 w-5 text-ai-orange" />}
          </motion.div>
        </AnimatePresence>
      </button>
    );
  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 divide-x divide-border">
        <div className={`px-2 py-1 ${!isDark ? 'bg-primary/10 text-primary' : 'text-muted-foreground'}`}>
